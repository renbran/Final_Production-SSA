var _a=Object.defineProperty;var Ct=t=>{throw TypeError(t)};var za=(t,a,i)=>a in t?_a(t,a,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[a]=i;var v=(t,a,i)=>za(t,typeof a!="symbol"?a+"":a,i),it=(t,a,i)=>a.has(t)||Ct("Cannot "+i);var h=(t,a,i)=>(it(t,a,"read from private field"),i?i.call(t):a.get(t)),S=(t,a,i)=>a.has(t)?Ct("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,i),N=(t,a,i,n)=>(it(t,a,"write to private field"),n?n.call(t,i):a.set(t,i),i),k=(t,a,i)=>(it(t,a,"access private method"),i);var At=(t,a,i,n)=>({set _(s){N(t,a,s,i)},get _(){return h(t,a,n)}});var ta={Stringify:1},j=(t,a)=>{const i=new String(t);return i.isEscaped=!0,i.callbacks=a,i},$a=/[&<>'"]/,aa=async(t,a)=>{let i="";a||(a=[]);const n=await Promise.all(t);for(let s=n.length-1;i+=n[s],s--,!(s<0);s--){let r=n[s];typeof r=="object"&&a.push(...r.callbacks||[]);const l=r.isEscaped;if(r=await(typeof r=="object"?r.toString():r),typeof r=="object"&&a.push(...r.callbacks||[]),r.isEscaped??l)i+=r;else{const o=[i];te(r,o),i=o[0]}}return j(i,a)},te=(t,a)=>{const i=t.search($a);if(i===-1){a[0]+=t;return}let n,s,r=0;for(s=i;s<t.length;s++){switch(t.charCodeAt(s)){case 34:n="&quot;";break;case 39:n="&#39;";break;case 38:n="&amp;";break;case 60:n="&lt;";break;case 62:n="&gt;";break;default:continue}a[0]+=t.substring(r,s)+n,r=s+1}a[0]+=t.substring(r,s)},ia=t=>{const a=t.callbacks;if(!(a!=null&&a.length))return t;const i=[t],n={};return a.forEach(s=>s({phase:ta.Stringify,buffer:i,context:n})),i[0]},na=async(t,a,i,n,s)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const r=t.callbacks;return r!=null&&r.length?(s?s[0]+=t:s=[t],Promise.all(r.map(o=>o({phase:a,buffer:s,context:n}))).then(o=>Promise.all(o.filter(Boolean).map(c=>na(c,a,!1,n,s))).then(()=>s[0]))):Promise.resolve(t)},Ga=(t,...a)=>{const i=[""];for(let n=0,s=t.length-1;n<s;n++){i[0]+=t[n];const r=Array.isArray(a[n])?a[n].flat(1/0):[a[n]];for(let l=0,o=r.length;l<o;l++){const c=r[l];if(typeof c=="string")te(c,i);else if(typeof c=="number")i[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)i.unshift("",c);else{const d=c.toString();d instanceof Promise?i.unshift("",d):i[0]+=d}else c instanceof Promise?i.unshift("",c):te(c.toString(),i)}}}return i[0]+=t.at(-1),i.length===1?"callbacks"in i?j(ia(j(i[0],i.callbacks))):j(i[0]):aa(i,i.callbacks)},bt=Symbol("RENDERER"),ut=Symbol("ERROR_HANDLER"),A=Symbol("STASH"),sa=Symbol("INTERNAL"),Ua=Symbol("MEMO"),Je=Symbol("PERMALINK"),Tt=t=>(t[sa]=!0,t),ra=t=>({value:a,children:i})=>{if(!i)return;const n={children:[{tag:Tt(()=>{t.push(a)}),props:{}}]};Array.isArray(i)?n.children.push(...i.flat()):n.children.push(i),n.children.push({tag:Tt(()=>{t.pop()}),props:{}});const s={tag:"",props:n,type:""};return s[ut]=r=>{throw t.pop(),r},s},la=t=>{const a=[t],i=ra(a);return i.values=a,i.Provider=i,we.push(i),i},we=[],Nt=t=>{const a=[t],i=n=>{a.push(n.value);let s;try{s=n.children?(Array.isArray(n.children)?new ha("",{},n.children):n.children).toString():""}finally{a.pop()}return s instanceof Promise?s.then(r=>j(r,r.callbacks)):j(s)};return i.values=a,i.Provider=i,i[bt]=ra(a),we.push(i),i},Ee=t=>t.values.at(-1),$e={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},ft={},Ge="data-precedence",Be=t=>Array.isArray(t)?t:[t],Pt=new WeakMap,Mt=(t,a,i,n)=>({buffer:s,context:r})=>{if(!s)return;const l=Pt.get(r)||{};Pt.set(r,l);const o=l[t]||(l[t]=[]);let c=!1;const d=$e[t];if(d.length>0){e:for(const[,m]of o)for(const u of d)if(((m==null?void 0:m[u])??null)===(i==null?void 0:i[u])){c=!0;break e}}if(c?s[0]=s[0].replaceAll(a,""):d.length>0?o.push([a,i,n]):o.unshift([a,i,n]),s[0].indexOf("</head>")!==-1){let m;if(n===void 0)m=o.map(([u])=>u);else{const u=[];m=o.map(([f,,g])=>{let b=u.indexOf(g);return b===-1&&(u.push(g),b=u.length-1),[f,b]}).sort((f,g)=>f[1]-g[1]).map(([f])=>f)}m.forEach(u=>{s[0]=s[0].replaceAll(u,"")}),s[0]=s[0].replace(/(?=<\/head>)/,m.join(""))}},He=(t,a,i)=>j(new F(t,i,Be(a??[])).toString()),Fe=(t,a,i,n)=>{if("itemProp"in i)return He(t,a,i);let{precedence:s,blocking:r,...l}=i;s=n?s??"":void 0,n&&(l[Ge]=s);const o=new F(t,l,Be(a||[])).toString();return o instanceof Promise?o.then(c=>j(o,[...c.callbacks||[],Mt(t,c,l,s)])):j(o,[Mt(t,o,l,s)])},Va=({children:t,...a})=>{const i=wt();if(i){const n=Ee(i);if(n==="svg"||n==="head")return new F("title",a,Be(t??[]))}return Fe("title",t,a,!1)},Wa=({children:t,...a})=>{const i=wt();return["src","async"].some(n=>!a[n])||i&&Ee(i)==="head"?He("script",t,a):Fe("script",t,a,!1)},Xa=({children:t,...a})=>["href","precedence"].every(i=>i in a)?(a["data-href"]=a.href,delete a.href,Fe("style",t,a,!0)):He("style",t,a),Ya=({children:t,...a})=>["onLoad","onError"].some(i=>i in a)||a.rel==="stylesheet"&&(!("precedence"in a)||"disabled"in a)?He("link",t,a):Fe("link",t,a,"precedence"in a),Ka=({children:t,...a})=>{const i=wt();return i&&Ee(i)==="head"?He("meta",t,a):Fe("meta",t,a,!1)},oa=(t,{children:a,...i})=>new F(t,i,Be(a??[])),Ja=t=>(typeof t.action=="function"&&(t.action=Je in t.action?t.action[Je]:void 0),oa("form",t)),ca=(t,a)=>(typeof a.formAction=="function"&&(a.formAction=Je in a.formAction?a.formAction[Je]:void 0),oa(t,a)),Za=t=>ca("input",t),Qa=t=>ca("button",t);const nt=Object.freeze(Object.defineProperty({__proto__:null,button:Qa,form:Ja,input:Za,link:Ya,meta:Ka,script:Wa,style:Xa,title:Va},Symbol.toStringTag,{value:"Module"}));var ei=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),Ze=t=>ei.get(t)||t,da=(t,a)=>{for(const[i,n]of Object.entries(t)){const s=i[0]==="-"||!/[A-Z]/.test(i)?i:i.replace(/[A-Z]/g,r=>`-${r.toLowerCase()}`);a(s,n==null?null:typeof n=="number"?s.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${n}`:`${n}px`:n)}},Te=void 0,wt=()=>Te,ti=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,ai=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ii=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],St=(t,a)=>{for(let i=0,n=t.length;i<n;i++){const s=t[i];if(typeof s=="string")te(s,a);else{if(typeof s=="boolean"||s===null||s===void 0)continue;s instanceof F?s.toStringToBuffer(a):typeof s=="number"||s.isEscaped?a[0]+=s:s instanceof Promise?a.unshift("",s):St(s,a)}}},F=class{constructor(t,a,i){v(this,"tag");v(this,"props");v(this,"key");v(this,"children");v(this,"isEscaped",!0);v(this,"localContexts");this.tag=t,this.props=a,this.children=i}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var a,i;const t=[""];(a=this.localContexts)==null||a.forEach(([n,s])=>{n.values.push(s)});try{this.toStringToBuffer(t)}finally{(i=this.localContexts)==null||i.forEach(([n])=>{n.values.pop()})}return t.length===1?"callbacks"in t?ia(j(t[0],t.callbacks)).toString():t[0]:aa(t,t.callbacks)}toStringToBuffer(t){const a=this.tag,i=this.props;let{children:n}=this;t[0]+=`<${a}`;const s=Te&&Ee(Te)==="svg"?r=>ti(Ze(r)):r=>Ze(r);for(let[r,l]of Object.entries(i))if(r=s(r),r!=="children"){if(r==="style"&&typeof l=="object"){let o="";da(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',te(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${r}="`,te(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${r}="${l}"`;else if(typeof l=="boolean"&&ii.includes(r))l&&(t[0]+=` ${r}=""`);else if(r==="dangerouslySetInnerHTML"){if(n.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");n=[j(l.__html)]}else if(l instanceof Promise)t[0]+=` ${r}="`,t.unshift('"',l);else if(typeof l=="function"){if(!r.startsWith("on")&&r!=="ref")throw new Error(`Invalid prop '${r}' of type 'function' supplied to '${a}'.`)}else t[0]+=` ${r}="`,te(l.toString(),t),t[0]+='"'}if(ai.includes(a)&&n.length===0){t[0]+="/>";return}t[0]+=">",St(n,t),t[0]+=`</${a}>`}},st=class extends F{toStringToBuffer(t){const{children:a}=this,i=this.tag.call(null,{...this.props,children:a.length<=1?a[0]:a});if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(we.length===0)t.unshift("",i);else{const n=we.map(s=>[s,s.values.at(-1)]);t.unshift("",i.then(s=>(s instanceof F&&(s.localContexts=n),s)))}else i instanceof F?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):te(i,t)}},ha=class extends F{toStringToBuffer(t){St(this.children,t)}},Lt=(t,a,...i)=>{a??(a={}),i.length&&(a.children=i.length===1?i[0]:i);const n=a.key;delete a.key;const s=Ue(t,a,i);return s.key=n,s},Rt=!1,Ue=(t,a,i)=>{if(!Rt){for(const n in ft)nt[n][bt]=ft[n];Rt=!0}return typeof t=="function"?new st(t,a,i):nt[t]?new st(nt[t],a,i):t==="svg"||t==="head"?(Te||(Te=Nt("")),new F(t,a,[new st(Te,{value:t},i)])):new F(t,a,i)},ni=({children:t})=>new ha("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,a,i){let n;if(!a||!("children"in a))n=Ue(t,a,[]);else{const s=a.children;n=Array.isArray(s)?Ue(t,a,s):Ue(t,a,[s])}return n.key=i,n}var It=(t,a,i)=>(n,s)=>{let r=-1;return l(0);async function l(o){if(o<=r)throw new Error("next() called multiple times");r=o;let c,d=!1,m;if(t[o]?(m=t[o][0][0],n.req.routeIndex=o):m=o===t.length&&s||void 0,m)try{c=await m(n,()=>l(o+1))}catch(u){if(u instanceof Error&&a)n.error=u,c=await a(u,n),d=!0;else throw u}else n.finalized===!1&&i&&(c=await i(n));return c&&(n.finalized===!1||d)&&(n.res=c),n}},si=Symbol(),ri=async(t,a=Object.create(null))=>{const{all:i=!1,dot:n=!1}=a,r=(t instanceof va?t.raw.headers:t.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?li(t,{all:i,dot:n}):{}};async function li(t,a){const i=await t.formData();return i?oi(i,a):{}}function oi(t,a){const i=Object.create(null);return t.forEach((n,s)=>{a.all||s.endsWith("[]")?ci(i,s,n):i[s]=n}),a.dot&&Object.entries(i).forEach(([n,s])=>{n.includes(".")&&(di(i,n,s),delete i[n])}),i}var ci=(t,a,i)=>{t[a]!==void 0?Array.isArray(t[a])?t[a].push(i):t[a]=[t[a],i]:a.endsWith("[]")?t[a]=[i]:t[a]=i},di=(t,a,i)=>{let n=t;const s=a.split(".");s.forEach((r,l)=>{l===s.length-1?n[r]=i:((!n[r]||typeof n[r]!="object"||Array.isArray(n[r])||n[r]instanceof File)&&(n[r]=Object.create(null)),n=n[r])})},ma=t=>{const a=t.split("/");return a[0]===""&&a.shift(),a},hi=t=>{const{groups:a,path:i}=mi(t),n=ma(i);return ui(n,a)},mi=t=>{const a=[];return t=t.replace(/\{[^}]+\}/g,(i,n)=>{const s=`@${n}`;return a.push([s,i]),s}),{groups:a,path:t}},ui=(t,a)=>{for(let i=a.length-1;i>=0;i--){const[n]=a[i];for(let s=t.length-1;s>=0;s--)if(t[s].includes(n)){t[s]=t[s].replace(n,a[i][1]);break}}return t},_e={},fi=(t,a)=>{if(t==="*")return"*";const i=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(i){const n=`${t}#${a}`;return _e[n]||(i[2]?_e[n]=a&&a[0]!==":"&&a[0]!=="*"?[n,i[1],new RegExp(`^${i[2]}(?=/${a})`)]:[t,i[1],new RegExp(`^${i[2]}$`)]:_e[n]=[t,i[1],!0]),_e[n]}return null},Et=(t,a)=>{try{return a(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,i=>{try{return a(i)}catch{return i}})}},pi=t=>Et(t,decodeURI),ua=t=>{const a=t.url,i=a.indexOf("/",a.indexOf(":")+4);let n=i;for(;n<a.length;n++){const s=a.charCodeAt(n);if(s===37){const r=a.indexOf("?",n),l=a.slice(i,r===-1?void 0:r);return pi(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(s===63)break}return a.slice(i,n)},gi=t=>{const a=ua(t);return a.length>1&&a.at(-1)==="/"?a.slice(0,-1):a},ue=(t,a,...i)=>(i.length&&(a=ue(a,...i)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${a==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(a==null?void 0:a[0])==="/"?a.slice(1):a}`}`),fa=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const a=t.split("/"),i=[];let n="";return a.forEach(s=>{if(s!==""&&!/\:/.test(s))n+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){i.length===0&&n===""?i.push("/"):i.push(n);const r=s.replace("?","");n+="/"+r,i.push(n)}else n+="/"+s}),i.filter((s,r,l)=>l.indexOf(s)===r)},rt=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Et(t,ga):t):t,pa=(t,a,i)=>{let n;if(!i&&a&&!/[%+]/.test(a)){let l=t.indexOf(`?${a}`,8);for(l===-1&&(l=t.indexOf(`&${a}`,8));l!==-1;){const o=t.charCodeAt(l+a.length+1);if(o===61){const c=l+a.length+2,d=t.indexOf("&",c);return rt(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${a}`,l+1)}if(n=/[%+]/.test(t),!n)return}const s={};n??(n=/[%+]/.test(t));let r=t.indexOf("?",8);for(;r!==-1;){const l=t.indexOf("&",r+1);let o=t.indexOf("=",r);o>l&&l!==-1&&(o=-1);let c=t.slice(r+1,o===-1?l===-1?void 0:l:o);if(n&&(c=rt(c)),r=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),n&&(d=rt(d))),i?(s[c]&&Array.isArray(s[c])||(s[c]=[]),s[c].push(d)):s[c]??(s[c]=d)}return a?s[a]:s},vi=pa,yi=(t,a)=>pa(t,a,!0),ga=decodeURIComponent,Ot=t=>Et(t,ga),ge,O,W,ya,ba,pt,Y,Vt,va=(Vt=class{constructor(t,a="/",i=[[]]){S(this,W);v(this,"raw");S(this,ge);S(this,O);v(this,"routeIndex",0);v(this,"path");v(this,"bodyCache",{});S(this,Y,t=>{const{bodyCache:a,raw:i}=this,n=a[t];if(n)return n;const s=Object.keys(a)[0];return s?a[s].then(r=>(s==="json"&&(r=JSON.stringify(r)),new Response(r)[t]())):a[t]=i[t]()});this.raw=t,this.path=a,N(this,O,i),N(this,ge,{})}param(t){return t?k(this,W,ya).call(this,t):k(this,W,ba).call(this)}query(t){return vi(this.url,t)}queries(t){return yi(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const a={};return this.raw.headers.forEach((i,n)=>{a[n]=i}),a}async parseBody(t){var a;return(a=this.bodyCache).parsedBody??(a.parsedBody=await ri(this,t))}json(){return h(this,Y).call(this,"text").then(t=>JSON.parse(t))}text(){return h(this,Y).call(this,"text")}arrayBuffer(){return h(this,Y).call(this,"arrayBuffer")}blob(){return h(this,Y).call(this,"blob")}formData(){return h(this,Y).call(this,"formData")}addValidatedData(t,a){h(this,ge)[t]=a}valid(t){return h(this,ge)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[si](){return h(this,O)}get matchedRoutes(){return h(this,O)[0].map(([[,t]])=>t)}get routePath(){return h(this,O)[0].map(([[,t]])=>t)[this.routeIndex].path}},ge=new WeakMap,O=new WeakMap,W=new WeakSet,ya=function(t){const a=h(this,O)[0][this.routeIndex][1][t],i=k(this,W,pt).call(this,a);return i&&/\%/.test(i)?Ot(i):i},ba=function(){const t={},a=Object.keys(h(this,O)[0][this.routeIndex][1]);for(const i of a){const n=k(this,W,pt).call(this,h(this,O)[0][this.routeIndex][1][i]);n!==void 0&&(t[i]=/\%/.test(n)?Ot(n):n)}return t},pt=function(t){return h(this,O)[1]?h(this,O)[1][t]:t},Y=new WeakMap,Vt),bi="text/plain; charset=UTF-8",lt=(t,a)=>({"Content-Type":t,...a}),Le,Re,$,ve,G,I,Ie,ye,be,se,Oe,je,K,fe,Wt,Ni=(Wt=class{constructor(t,a){S(this,K);S(this,Le);S(this,Re);v(this,"env",{});S(this,$);v(this,"finalized",!1);v(this,"error");S(this,ve);S(this,G);S(this,I);S(this,Ie);S(this,ye);S(this,be);S(this,se);S(this,Oe);S(this,je);v(this,"render",(...t)=>(h(this,ye)??N(this,ye,a=>this.html(a)),h(this,ye).call(this,...t)));v(this,"setLayout",t=>N(this,Ie,t));v(this,"getLayout",()=>h(this,Ie));v(this,"setRenderer",t=>{N(this,ye,t)});v(this,"header",(t,a,i)=>{this.finalized&&N(this,I,new Response(h(this,I).body,h(this,I)));const n=h(this,I)?h(this,I).headers:h(this,se)??N(this,se,new Headers);a===void 0?n.delete(t):i!=null&&i.append?n.append(t,a):n.set(t,a)});v(this,"status",t=>{N(this,ve,t)});v(this,"set",(t,a)=>{h(this,$)??N(this,$,new Map),h(this,$).set(t,a)});v(this,"get",t=>h(this,$)?h(this,$).get(t):void 0);v(this,"newResponse",(...t)=>k(this,K,fe).call(this,...t));v(this,"body",(t,a,i)=>k(this,K,fe).call(this,t,a,i));v(this,"text",(t,a,i)=>!h(this,se)&&!h(this,ve)&&!a&&!i&&!this.finalized?new Response(t):k(this,K,fe).call(this,t,a,lt(bi,i)));v(this,"json",(t,a,i)=>k(this,K,fe).call(this,JSON.stringify(t),a,lt("application/json",i)));v(this,"html",(t,a,i)=>{const n=s=>k(this,K,fe).call(this,s,a,lt("text/html; charset=UTF-8",i));return typeof t=="object"?na(t,ta.Stringify,!1,{}).then(n):n(t)});v(this,"redirect",(t,a)=>{const i=String(t);return this.header("Location",/[^\x00-\xFF]/.test(i)?encodeURI(i):i),this.newResponse(null,a??302)});v(this,"notFound",()=>(h(this,be)??N(this,be,()=>new Response),h(this,be).call(this,this)));N(this,Le,t),a&&(N(this,G,a.executionCtx),this.env=a.env,N(this,be,a.notFoundHandler),N(this,je,a.path),N(this,Oe,a.matchResult))}get req(){return h(this,Re)??N(this,Re,new va(h(this,Le),h(this,je),h(this,Oe))),h(this,Re)}get event(){if(h(this,G)&&"respondWith"in h(this,G))return h(this,G);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,G))return h(this,G);throw Error("This context has no ExecutionContext")}get res(){return h(this,I)||N(this,I,new Response(null,{headers:h(this,se)??N(this,se,new Headers)}))}set res(t){if(h(this,I)&&t){t=new Response(t.body,t);for(const[a,i]of h(this,I).headers.entries())if(a!=="content-type")if(a==="set-cookie"){const n=h(this,I).headers.getSetCookie();t.headers.delete("set-cookie");for(const s of n)t.headers.append("set-cookie",s)}else t.headers.set(a,i)}N(this,I,t),this.finalized=!0}get var(){return h(this,$)?Object.fromEntries(h(this,$)):{}}},Le=new WeakMap,Re=new WeakMap,$=new WeakMap,ve=new WeakMap,G=new WeakMap,I=new WeakMap,Ie=new WeakMap,ye=new WeakMap,be=new WeakMap,se=new WeakMap,Oe=new WeakMap,je=new WeakMap,K=new WeakSet,fe=function(t,a,i){const n=h(this,I)?new Headers(h(this,I).headers):h(this,se)??new Headers;if(typeof a=="object"&&"headers"in a){const r=a.headers instanceof Headers?a.headers:new Headers(a.headers);for(const[l,o]of r)l.toLowerCase()==="set-cookie"?n.append(l,o):n.set(l,o)}if(i)for(const[r,l]of Object.entries(i))if(typeof l=="string")n.set(r,l);else{n.delete(r);for(const o of l)n.append(r,o)}const s=typeof a=="number"?a:(a==null?void 0:a.status)??h(this,ve);return new Response(t,{status:s,headers:n})},Wt),T="ALL",wi="all",Si=["get","post","put","delete","options","patch"],Na="Can not add a route since the matcher is already built.",wa=class extends Error{},Ei="__COMPOSED_HANDLER",xi=t=>t.text("404 Not Found",404),jt=(t,a)=>{if("getResponse"in t){const i=t.getResponse();return a.newResponse(i.body,i)}return console.error(t),a.text("Internal Server Error",500)},D,P,Ea,B,ie,Ve,We,Xt,Sa=(Xt=class{constructor(a={}){S(this,P);v(this,"get");v(this,"post");v(this,"put");v(this,"delete");v(this,"options");v(this,"patch");v(this,"all");v(this,"on");v(this,"use");v(this,"router");v(this,"getPath");v(this,"_basePath","/");S(this,D,"/");v(this,"routes",[]);S(this,B,xi);v(this,"errorHandler",jt);v(this,"onError",a=>(this.errorHandler=a,this));v(this,"notFound",a=>(N(this,B,a),this));v(this,"fetch",(a,...i)=>k(this,P,We).call(this,a,i[1],i[0],a.method));v(this,"request",(a,i,n,s)=>a instanceof Request?this.fetch(i?new Request(a,i):a,n,s):(a=a.toString(),this.fetch(new Request(/^https?:\/\//.test(a)?a:`http://localhost${ue("/",a)}`,i),n,s)));v(this,"fire",()=>{addEventListener("fetch",a=>{a.respondWith(k(this,P,We).call(this,a.request,a,void 0,a.request.method))})});[...Si,wi].forEach(r=>{this[r]=(l,...o)=>(typeof l=="string"?N(this,D,l):k(this,P,ie).call(this,r,h(this,D),l),o.forEach(c=>{k(this,P,ie).call(this,r,h(this,D),c)}),this)}),this.on=(r,l,...o)=>{for(const c of[l].flat()){N(this,D,c);for(const d of[r].flat())o.map(m=>{k(this,P,ie).call(this,d.toUpperCase(),h(this,D),m)})}return this},this.use=(r,...l)=>(typeof r=="string"?N(this,D,r):(N(this,D,"*"),l.unshift(r)),l.forEach(o=>{k(this,P,ie).call(this,T,h(this,D),o)}),this);const{strict:n,...s}=a;Object.assign(this,s),this.getPath=n??!0?a.getPath??ua:gi}route(a,i){const n=this.basePath(a);return i.routes.map(s=>{var l;let r;i.errorHandler===jt?r=s.handler:(r=async(o,c)=>(await It([],i.errorHandler)(o,()=>s.handler(o,c))).res,r[Ei]=s.handler),k(l=n,P,ie).call(l,s.method,s.path,r)}),this}basePath(a){const i=k(this,P,Ea).call(this);return i._basePath=ue(this._basePath,a),i}mount(a,i,n){let s,r;n&&(typeof n=="function"?r=n:(r=n.optionHandler,n.replaceRequest===!1?s=c=>c:s=n.replaceRequest));const l=r?c=>{const d=r(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};s||(s=(()=>{const c=ue(this._basePath,a),d=c==="/"?0:c.length;return m=>{const u=new URL(m.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,m)}})());const o=async(c,d)=>{const m=await i(s(c.req.raw),...l(c));if(m)return m;await d()};return k(this,P,ie).call(this,T,ue(a,"*"),o),this}},D=new WeakMap,P=new WeakSet,Ea=function(){const a=new Sa({router:this.router,getPath:this.getPath});return a.errorHandler=this.errorHandler,N(a,B,h(this,B)),a.routes=this.routes,a},B=new WeakMap,ie=function(a,i,n){a=a.toUpperCase(),i=ue(this._basePath,i);const s={basePath:this._basePath,path:i,method:a,handler:n};this.router.add(a,i,[n,s]),this.routes.push(s)},Ve=function(a,i){if(a instanceof Error)return this.errorHandler(a,i);throw a},We=function(a,i,n,s){if(s==="HEAD")return(async()=>new Response(null,await k(this,P,We).call(this,a,i,n,"GET")))();const r=this.getPath(a,{env:n}),l=this.router.match(s,r),o=new Ni(a,{path:r,matchResult:l,env:n,executionCtx:i,notFoundHandler:h(this,B)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await h(this,B).call(this,o)})}catch(m){return k(this,P,Ve).call(this,m,o)}return d instanceof Promise?d.then(m=>m||(o.finalized?o.res:h(this,B).call(this,o))).catch(m=>k(this,P,Ve).call(this,m,o)):d??h(this,B).call(this,o)}const c=It(l[0],this.errorHandler,h(this,B));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return k(this,P,Ve).call(this,d,o)}})()},Xt),xa=[],ka=Symbol("buildAllMatchers");function ki(t,a){const i=this[ka](),n=(s,r)=>{const l=i[s]||i[T],o=l[2][r];if(o)return o;const c=r.match(l[0]);if(!c)return[[],xa];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=n,n(t,a)}var Qe="[^/]+",Ce=".*",Ae="(?:|/.*)",pe=Symbol(),Ci=new Set(".\\+*[^]$()");function Ai(t,a){return t.length===1?a.length===1?t<a?-1:1:-1:a.length===1||t===Ce||t===Ae?1:a===Ce||a===Ae?-1:t===Qe?1:a===Qe?-1:t.length===a.length?t<a?-1:1:a.length-t.length}var re,le,H,Yt,gt=(Yt=class{constructor(){S(this,re);S(this,le);S(this,H,Object.create(null))}insert(a,i,n,s,r){if(a.length===0){if(h(this,re)!==void 0)throw pe;if(r)return;N(this,re,i);return}const[l,...o]=a,c=l==="*"?o.length===0?["","",Ce]:["","",Qe]:l==="/*"?["","",Ae]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const m=c[1];let u=c[2]||Qe;if(m&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw pe;if(d=h(this,H)[u],!d){if(Object.keys(h(this,H)).some(f=>f!==Ce&&f!==Ae))throw pe;if(r)return;d=h(this,H)[u]=new gt,m!==""&&N(d,le,s.varIndex++)}!r&&m!==""&&n.push([m,h(d,le)])}else if(d=h(this,H)[l],!d){if(Object.keys(h(this,H)).some(m=>m.length>1&&m!==Ce&&m!==Ae))throw pe;if(r)return;d=h(this,H)[l]=new gt}d.insert(o,i,n,s,r)}buildRegExpStr(){const i=Object.keys(h(this,H)).sort(Ai).map(n=>{const s=h(this,H)[n];return(typeof h(s,le)=="number"?`(${n})@${h(s,le)}`:Ci.has(n)?`\\${n}`:n)+s.buildRegExpStr()});return typeof h(this,re)=="number"&&i.unshift(`#${h(this,re)}`),i.length===0?"":i.length===1?i[0]:"(?:"+i.join("|")+")"}},re=new WeakMap,le=new WeakMap,H=new WeakMap,Yt),et,De,Kt,Ti=(Kt=class{constructor(){S(this,et,{varIndex:0});S(this,De,new gt)}insert(t,a,i){const n=[],s=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return s[l]=[d,c],l++,o=!0,d}),!o)break}const r=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=s.length-1;l>=0;l--){const[o]=s[l];for(let c=r.length-1;c>=0;c--)if(r[c].indexOf(o)!==-1){r[c]=r[c].replace(o,s[l][1]);break}}return h(this,De).insert(r,a,n,h(this,et),i),n}buildRegExp(){let t=h(this,De).buildRegExpStr();if(t==="")return[/^$/,[],[]];let a=0;const i=[],n=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,r,l)=>r!==void 0?(i[++a]=Number(r),"$()"):(l!==void 0&&(n[Number(l)]=++a),"")),[new RegExp(`^${t}`),i,n]}},et=new WeakMap,De=new WeakMap,Kt),Pi=[/^$/,[],Object.create(null)],Xe=Object.create(null);function Ca(t){return Xe[t]??(Xe[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(a,i)=>i?`\\${i}`:"(?:|/.*)")}$`))}function Mi(){Xe=Object.create(null)}function Li(t){var d;const a=new Ti,i=[];if(t.length===0)return Pi;const n=t.map(m=>[!/\*|\/:/.test(m[0]),...m]).sort(([m,u],[f,g])=>m?1:f?-1:u.length-g.length),s=Object.create(null);for(let m=0,u=-1,f=n.length;m<f;m++){const[g,b,p]=n[m];g?s[b]=[p.map(([w])=>[w,Object.create(null)]),xa]:u++;let y;try{y=a.insert(b,u,g)}catch(w){throw w===pe?new wa(b):w}g||(i[u]=p.map(([w,E])=>{const C=Object.create(null);for(E-=1;E>=0;E--){const[x,L]=y[E];C[x]=L}return[w,C]}))}const[r,l,o]=a.buildRegExp();for(let m=0,u=i.length;m<u;m++)for(let f=0,g=i[m].length;f<g;f++){const b=(d=i[m][f])==null?void 0:d[1];if(!b)continue;const p=Object.keys(b);for(let y=0,w=p.length;y<w;y++)b[p[y]]=o[b[p[y]]]}const c=[];for(const m in l)c[m]=i[l[m]];return[r,c,s]}function he(t,a){if(t){for(const i of Object.keys(t).sort((n,s)=>s.length-n.length))if(Ca(i).test(a))return[...t[i]]}}var J,Z,tt,Aa,Jt,Ri=(Jt=class{constructor(){S(this,tt);v(this,"name","RegExpRouter");S(this,J);S(this,Z);v(this,"match",ki);N(this,J,{[T]:Object.create(null)}),N(this,Z,{[T]:Object.create(null)})}add(t,a,i){var o;const n=h(this,J),s=h(this,Z);if(!n||!s)throw new Error(Na);n[t]||[n,s].forEach(c=>{c[t]=Object.create(null),Object.keys(c[T]).forEach(d=>{c[t][d]=[...c[T][d]]})}),a==="/*"&&(a="*");const r=(a.match(/\/:/g)||[]).length;if(/\*$/.test(a)){const c=Ca(a);t===T?Object.keys(n).forEach(d=>{var m;(m=n[d])[a]||(m[a]=he(n[d],a)||he(n[T],a)||[])}):(o=n[t])[a]||(o[a]=he(n[t],a)||he(n[T],a)||[]),Object.keys(n).forEach(d=>{(t===T||t===d)&&Object.keys(n[d]).forEach(m=>{c.test(m)&&n[d][m].push([i,r])})}),Object.keys(s).forEach(d=>{(t===T||t===d)&&Object.keys(s[d]).forEach(m=>c.test(m)&&s[d][m].push([i,r]))});return}const l=fa(a)||[a];for(let c=0,d=l.length;c<d;c++){const m=l[c];Object.keys(s).forEach(u=>{var f;(t===T||t===u)&&((f=s[u])[m]||(f[m]=[...he(n[u],m)||he(n[T],m)||[]]),s[u][m].push([i,r-d+c+1]))})}}[ka](){const t=Object.create(null);return Object.keys(h(this,Z)).concat(Object.keys(h(this,J))).forEach(a=>{t[a]||(t[a]=k(this,tt,Aa).call(this,a))}),N(this,J,N(this,Z,void 0)),Mi(),t}},J=new WeakMap,Z=new WeakMap,tt=new WeakSet,Aa=function(t){const a=[];let i=t===T;return[h(this,J),h(this,Z)].forEach(n=>{const s=n[t]?Object.keys(n[t]).map(r=>[r,n[t][r]]):[];s.length!==0?(i||(i=!0),a.push(...s)):t!==T&&a.push(...Object.keys(n[T]).map(r=>[r,n[T][r]]))}),i?Li(a):null},Jt),Q,U,Zt,Ii=(Zt=class{constructor(t){v(this,"name","SmartRouter");S(this,Q,[]);S(this,U,[]);N(this,Q,t.routers)}add(t,a,i){if(!h(this,U))throw new Error(Na);h(this,U).push([t,a,i])}match(t,a){if(!h(this,U))throw new Error("Fatal error");const i=h(this,Q),n=h(this,U),s=i.length;let r=0,l;for(;r<s;r++){const o=i[r];try{for(let c=0,d=n.length;c<d;c++)o.add(...n[c]);l=o.match(t,a)}catch(c){if(c instanceof wa)continue;throw c}this.match=o.match.bind(o),N(this,Q,[o]),N(this,U,void 0);break}if(r===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(h(this,U)||h(this,Q).length!==1)throw new Error("No active router has been determined yet.");return h(this,Q)[0]}},Q=new WeakMap,U=new WeakMap,Zt),xe=Object.create(null),ee,R,oe,Ne,M,V,ne,Qt,Ta=(Qt=class{constructor(t,a,i){S(this,V);S(this,ee);S(this,R);S(this,oe);S(this,Ne,0);S(this,M,xe);if(N(this,R,i||Object.create(null)),N(this,ee,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},N(this,ee,[n])}N(this,oe,[])}insert(t,a,i){N(this,Ne,++At(this,Ne)._);let n=this;const s=hi(a),r=[];for(let l=0,o=s.length;l<o;l++){const c=s[l],d=s[l+1],m=fi(c,d),u=Array.isArray(m)?m[0]:c;if(u in h(n,R)){n=h(n,R)[u],m&&r.push(m[1]);continue}h(n,R)[u]=new Ta,m&&(h(n,oe).push(m),r.push(m[1])),n=h(n,R)[u]}return h(n,ee).push({[t]:{handler:i,possibleKeys:r.filter((l,o,c)=>c.indexOf(l)===o),score:h(this,Ne)}}),n}search(t,a){var o;const i=[];N(this,M,xe);let s=[this];const r=ma(a),l=[];for(let c=0,d=r.length;c<d;c++){const m=r[c],u=c===d-1,f=[];for(let g=0,b=s.length;g<b;g++){const p=s[g],y=h(p,R)[m];y&&(N(y,M,h(p,M)),u?(h(y,R)["*"]&&i.push(...k(this,V,ne).call(this,h(y,R)["*"],t,h(p,M))),i.push(...k(this,V,ne).call(this,y,t,h(p,M)))):f.push(y));for(let w=0,E=h(p,oe).length;w<E;w++){const C=h(p,oe)[w],x=h(p,M)===xe?{}:{...h(p,M)};if(C==="*"){const X=h(p,R)["*"];X&&(i.push(...k(this,V,ne).call(this,X,t,h(p,M))),N(X,M,x),f.push(X));continue}const[L,de,ae]=C;if(!m&&!(ae instanceof RegExp))continue;const _=h(p,R)[L],qa=r.slice(c).join("/");if(ae instanceof RegExp){const X=ae.exec(qa);if(X){if(x[de]=X[0],i.push(...k(this,V,ne).call(this,_,t,h(p,M),x)),Object.keys(h(_,R)).length){N(_,M,x);const at=((o=X[0].match(/\//))==null?void 0:o.length)??0;(l[at]||(l[at]=[])).push(_)}continue}}(ae===!0||ae.test(m))&&(x[de]=m,u?(i.push(...k(this,V,ne).call(this,_,t,x,h(p,M))),h(_,R)["*"]&&i.push(...k(this,V,ne).call(this,h(_,R)["*"],t,x,h(p,M)))):(N(_,M,x),f.push(_)))}}s=f.concat(l.shift()??[])}return i.length>1&&i.sort((c,d)=>c.score-d.score),[i.map(({handler:c,params:d})=>[c,d])]}},ee=new WeakMap,R=new WeakMap,oe=new WeakMap,Ne=new WeakMap,M=new WeakMap,V=new WeakSet,ne=function(t,a,i,n){const s=[];for(let r=0,l=h(t,ee).length;r<l;r++){const o=h(t,ee)[r],c=o[a]||o[T],d={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),i!==xe||n&&n!==xe))for(let m=0,u=c.possibleKeys.length;m<u;m++){const f=c.possibleKeys[m],g=d[c.score];c.params[f]=n!=null&&n[f]&&!g?n[f]:i[f]??(n==null?void 0:n[f]),d[c.score]=!0}}return s},Qt),ce,ea,Oi=(ea=class{constructor(){v(this,"name","TrieRouter");S(this,ce);N(this,ce,new Ta)}add(t,a,i){const n=fa(a);if(n){for(let s=0,r=n.length;s<r;s++)h(this,ce).insert(t,n[s],i);return}h(this,ce).insert(t,a,i)}match(t,a){return h(this,ce).search(t,a)}},ce=new WeakMap,ea),Pa=class extends Sa{constructor(t={}){super(t),this.router=t.router??new Ii({routers:[new Ri,new Oi]})}},ji=t=>{const i={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...t},n=(r=>typeof r=="string"?r==="*"?()=>r:l=>r===l?l:null:typeof r=="function"?r:l=>r.includes(l)?l:null)(i.origin),s=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(i.allowMethods);return async function(l,o){var m;function c(u,f){l.res.headers.set(u,f)}const d=await n(l.req.header("origin")||"",l);if(d&&c("Access-Control-Allow-Origin",d),i.origin!=="*"){const u=l.req.header("Vary");u?c("Vary",u):c("Vary","Origin")}if(i.credentials&&c("Access-Control-Allow-Credentials","true"),(m=i.exposeHeaders)!=null&&m.length&&c("Access-Control-Expose-Headers",i.exposeHeaders.join(",")),l.req.method==="OPTIONS"){i.maxAge!=null&&c("Access-Control-Max-Age",i.maxAge.toString());const u=await s(l.req.header("origin")||"",l);u.length&&c("Access-Control-Allow-Methods",u.join(","));let f=i.allowHeaders;if(!(f!=null&&f.length)){const g=l.req.header("Access-Control-Request-Headers");g&&(f=g.split(/\s*,\s*/))}return f!=null&&f.length&&(c("Access-Control-Allow-Headers",f.join(",")),l.res.headers.append("Vary","Access-Control-Request-Headers")),l.res.headers.delete("Content-Length"),l.res.headers.delete("Content-Type"),new Response(null,{headers:l.res.headers,status:204,statusText:"No Content"})}await o()}},Di=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Dt=(t,a=Hi)=>{const i=/\.([a-zA-Z0-9]+?)$/,n=t.match(i);if(!n)return;let s=a[n[1]];return s&&s.startsWith("text")&&(s+="; charset=utf-8"),s},Bi={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Hi=Bi,Fi=(...t)=>{let a=t.filter(s=>s!=="").join("/");a=a.replace(new RegExp("(?<=\\/)\\/+","g"),"");const i=a.split("/"),n=[];for(const s of i)s===".."&&n.length>0&&n.at(-1)!==".."?n.pop():s!=="."&&n.push(s);return n.join("/")||"."},Ma={br:".br",zstd:".zst",gzip:".gz"},qi=Object.keys(Ma),_i="index.html",zi=t=>{const a=t.root??"./",i=t.path,n=t.join??Fi;return async(s,r)=>{var m,u,f,g;if(s.finalized)return r();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(s.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((m=t.onNotFound)==null?void 0:m.call(t,s.req.path,s)),r()}let o=n(a,!i&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=n(o,_i));const c=t.getContent;let d=await c(o,s);if(d instanceof Response)return s.newResponse(d.body,d);if(d){const b=t.mimes&&Dt(o,t.mimes)||Dt(o);if(s.header("Content-Type",b||"application/octet-stream"),t.precompressed&&(!b||Di.test(b))){const p=new Set((u=s.req.header("Accept-Encoding"))==null?void 0:u.split(",").map(y=>y.trim()));for(const y of qi){if(!p.has(y))continue;const w=await c(o+Ma[y],s);if(w){d=w,s.header("Content-Encoding",y),s.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,s)),s.body(d)}await((g=t.onNotFound)==null?void 0:g.call(t,o,s)),await r()}},$i=async(t,a)=>{let i;a&&a.manifest?typeof a.manifest=="string"?i=JSON.parse(a.manifest):i=a.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?i=JSON.parse(__STATIC_CONTENT_MANIFEST):i=__STATIC_CONTENT_MANIFEST;let n;a&&a.namespace?n=a.namespace:n=__STATIC_CONTENT;const s=i[t]||t;if(!s)return null;const r=await n.get(s,{type:"stream"});return r||null},Gi=t=>async function(i,n){return zi({...t,getContent:async r=>$i(r,{manifest:t.manifest,namespace:t.namespace?t.namespace:i.env?i.env.__STATIC_CONTENT:void 0})})(i,n)},Ui=t=>Gi(t),Pe="_hp",Vi={Change:"Input",DoubleClick:"DblClick"},Wi={svg:"2000/svg",math:"1998/Math/MathML"},Me=[],vt=new WeakMap,Se=void 0,Xi=()=>Se,z=t=>"t"in t,ot={onClick:["click",!1]},Bt=t=>{if(!t.startsWith("on"))return;if(ot[t])return ot[t];const a=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(a){const[,i,n]=a;return ot[t]=[(Vi[i]||i).toLowerCase(),!!n]}},Ht=(t,a)=>Se&&t instanceof SVGElement&&/[A-Z]/.test(a)&&(a in t.style||a.match(/^(?:o|pai|str|u|ve)/))?a.replace(/([A-Z])/g,"-$1").toLowerCase():a,Yi=(t,a,i)=>{var n;a||(a={});for(let s in a){const r=a[s];if(s!=="children"&&(!i||i[s]!==r)){s=Ze(s);const l=Bt(s);if(l){if((i==null?void 0:i[s])!==r&&(i&&t.removeEventListener(l[0],i[s],l[1]),r!=null)){if(typeof r!="function")throw new Error(`Event handler for "${s}" is not a function`);t.addEventListener(l[0],r,l[1])}}else if(s==="dangerouslySetInnerHTML"&&r)t.innerHTML=r.__html;else if(s==="ref"){let o;typeof r=="function"?o=r(t)||(()=>r(null)):r&&"current"in r&&(r.current=t,o=()=>r.current=null),vt.set(t,o)}else if(s==="style"){const o=t.style;typeof r=="string"?o.cssText=r:(o.cssText="",r!=null&&da(r,o.setProperty.bind(o)))}else{if(s==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=r==null||r===!1?null:r,c==="TEXTAREA"){t.textContent=r;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(s==="checked"&&t.nodeName==="INPUT"||s==="selected"&&t.nodeName==="OPTION")&&(t[s]=r);const o=Ht(t,s);r==null||r===!1?t.removeAttribute(o):r===!0?t.setAttribute(o,""):typeof r=="string"||typeof r=="number"?t.setAttribute(o,r):t.setAttribute(o,r.toString())}}}if(i)for(let s in i){const r=i[s];if(s!=="children"&&!(s in a)){s=Ze(s);const l=Bt(s);l?t.removeEventListener(l[0],r,l[1]):s==="ref"?(n=vt.get(t))==null||n():t.removeAttribute(Ht(t,s))}}},Ki=(t,a)=>{a[A][0]=0,Me.push([t,a]);const i=a.tag[bt]||a.tag,n=i.defaultProps?{...i.defaultProps,...a.props}:a.props;try{return[i.call(null,n)]}finally{Me.pop()}},La=(t,a,i,n,s)=>{var r,l;(r=t.vR)!=null&&r.length&&(n.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[A][1][ja])==null||l.forEach(o=>s.push(o))),t.vC.forEach(o=>{var c;if(z(o))i.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=a;const d=i.length;if(La(o,a,i,n,s),o.s){for(let m=d;m<i.length;m++)i[m].s=!0;o.s=!1}}else i.push(o),(c=o.vR)!=null&&c.length&&(n.push(...o.vR),delete o.vR)})},Ji=t=>{for(;;t=t.tag===Pe||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==Pe&&t.e)return t.e}},Ra=t=>{var a,i,n,s,r,l;z(t)||((i=(a=t[A])==null?void 0:a[1][ja])==null||i.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(n=vt.get(t.e))==null||n(),t.p===2&&((s=t.vC)==null||s.forEach(o=>o.p=2)),(r=t.vC)==null||r.forEach(Ra)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(ke.delete(t),Ye.delete(t),delete t[A][3],t.a=!0)},Ia=(t,a,i)=>{t.c=a,Oa(t,a,i)},Ft=(t,a)=>{if(a){for(let i=0,n=t.length;i<n;i++)if(t[i]===a)return i}},qt=Symbol(),Oa=(t,a,i)=>{var d;const n=[],s=[],r=[];La(t,a,n,s,r),s.forEach(Ra);const l=i?void 0:a.childNodes;let o,c=null;if(i)o=-1;else if(!l.length)o=0;else{const m=Ft(l,Ji(t.nN));m!==void 0?(c=l[m],o=m):o=Ft(l,(d=n.find(u=>u.tag!==Pe&&u.e))==null?void 0:d.e)??-1,o===-1&&(i=!0)}for(let m=0,u=n.length;m<u;m++,o++){const f=n[m];let g;if(f.s&&f.e)g=f.e,f.s=!1;else{const b=i||!f.e;z(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,g=f.e||(f.e=document.createTextNode(f.t))):(g=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),Yi(g,f.props,f.pP),Oa(f,g,b))}f.tag===Pe?o--:i?g.parentNode||a.appendChild(g):l[o]!==g&&l[o-1]!==g&&(l[o+1]===g?a.appendChild(l[o]):a.insertBefore(g,c||l[o]||null))}if(t.pP&&delete t.pP,r.length){const m=[],u=[];r.forEach(([,f,,g,b])=>{f&&m.push(f),g&&u.push(g),b==null||b()}),m.forEach(f=>f()),u.length&&requestAnimationFrame(()=>{u.forEach(f=>f())})}},Zi=(t,a)=>!!(t&&t.length===a.length&&t.every((i,n)=>i[1]===a[n][1])),Ye=new WeakMap,yt=(t,a,i)=>{var r,l,o,c,d,m;const n=!i&&a.pC;i&&(a.pC||(a.pC=a.vC));let s;try{i||(i=typeof a.tag=="function"?Ki(t,a):Be(a.props.children)),((r=i[0])==null?void 0:r.tag)===""&&i[0][ut]&&(s=i[0][ut],t[5].push([t,s,a]));const u=n?[...a.pC]:a.vC?[...a.vC]:void 0,f=[];let g;for(let b=0;b<i.length;b++){Array.isArray(i[b])&&i.splice(b,1,...i[b].flat());let p=Qi(i[b]);if(p){typeof p.tag=="function"&&!p.tag[sa]&&(we.length>0&&(p[A][2]=we.map(w=>[w,w.values.at(-1)])),(l=t[5])!=null&&l.length&&(p[A][3]=t[5].at(-1)));let y;if(u&&u.length){const w=u.findIndex(z(p)?E=>z(E):p.key!==void 0?E=>E.key===p.key&&E.tag===p.tag:E=>E.tag===p.tag);w!==-1&&(y=u[w],u.splice(w,1))}if(y)if(z(p))y.t!==p.t&&(y.t=p.t,y.d=!0),p=y;else{const w=y.pP=y.props;if(y.props=p.props,y.f||(y.f=p.f||a.f),typeof p.tag=="function"){const E=y[A][2];y[A][2]=p[A][2]||[],y[A][3]=p[A][3],!y.f&&((y.o||y)===p.o||(c=(o=y.tag)[Ua])!=null&&c.call(o,w,y.props))&&Zi(E,y[A][2])&&(y.s=!0)}p=y}else if(!z(p)&&Se){const w=Ee(Se);w&&(p.n=w)}if(!z(p)&&!p.s&&(yt(t,p),delete p.f),f.push(p),g&&!g.s&&!p.s)for(let w=g;w&&!z(w);w=(d=w.vC)==null?void 0:d.at(-1))w.nN=p;g=p}}a.vR=n?[...a.vC,...u||[]]:u||[],a.vC=f,n&&delete a.pC}catch(u){if(a.f=!0,u===qt){if(s)return;throw u}const[f,g,b]=((m=a[A])==null?void 0:m[3])||[];if(g){const p=()=>Ke([0,!1,t[2]],b),y=Ye.get(b)||[];y.push(p),Ye.set(b,y);const w=g(u,()=>{const E=Ye.get(b);if(E){const C=E.indexOf(p);if(C!==-1)return E.splice(C,1),p()}});if(w){if(t[0]===1)t[1]=!0;else if(yt(t,b,[w]),(g.length===1||t!==f)&&b.c){Ia(b,b.c,!1);return}throw qt}}throw u}finally{s&&t[5].pop()}},Qi=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[A]=[0,[]];else{const a=Wi[t.tag];a&&(Se||(Se=la("")),t.props.children=[{tag:Se,props:{value:t.n=`http://www.w3.org/${a}`,children:t.props.children}}])}return t}},_t=(t,a)=>{var i,n;(i=a[A][2])==null||i.forEach(([s,r])=>{s.values.push(r)});try{yt(t,a,void 0)}catch{return}if(a.a){delete a.a;return}(n=a[A][2])==null||n.forEach(([s])=>{s.values.pop()}),(t[0]!==1||!t[1])&&Ia(a,a.c,!1)},ke=new WeakMap,zt=[],Ke=async(t,a)=>{t[5]||(t[5]=[]);const i=ke.get(a);i&&i[0](void 0);let n;const s=new Promise(r=>n=r);if(ke.set(a,[n,()=>{t[2]?t[2](t,a,r=>{_t(r,a)}).then(()=>n(a)):(_t(t,a),n(a))}]),zt.length)zt.at(-1).add(a);else{await Promise.resolve();const r=ke.get(a);r&&(ke.delete(a),r[1]())}return s},en=(t,a,i)=>({tag:Pe,props:{children:t},key:i,e:a,p:1}),ct=0,ja=1,dt=2,ht=3,mt=new WeakMap,Da=(t,a)=>!t||!a||t.length!==a.length||a.some((i,n)=>i!==t[n]),tn=void 0,$t=[],an=t=>{var l;const a=()=>typeof t=="function"?t():t,i=Me.at(-1);if(!i)return[a(),()=>{}];const[,n]=i,s=(l=n[A][1])[ct]||(l[ct]=[]),r=n[A][0]++;return s[r]||(s[r]=[a(),o=>{const c=tn,d=s[r];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,$t.length){const[m,u]=$t.at(-1);Promise.all([m===3?n:Ke([m,!1,c],n),u]).then(([f])=>{if(!f||!(m===2||m===3))return;const g=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{g===f.vC&&Ke([m===3?1:0,!1,c],f)})})})}else Ke([0,!1,c],n)}])},xt=(t,a)=>{var o;const i=Me.at(-1);if(!i)return t;const[,n]=i,s=(o=n[A][1])[dt]||(o[dt]=[]),r=n[A][0]++,l=s[r];return Da(l==null?void 0:l[1],a)?s[r]=[t,a]:t=s[r][0],t},nn=t=>{const a=mt.get(t);if(a){if(a.length===2)throw a[1];return a[0]}throw t.then(i=>mt.set(t,[i]),i=>mt.set(t,[void 0,i])),t},sn=(t,a)=>{var o;const i=Me.at(-1);if(!i)return t();const[,n]=i,s=(o=n[A][1])[ht]||(o[ht]=[]),r=n[A][0]++,l=s[r];return Da(l==null?void 0:l[1],a)&&(s[r]=[t(),a]),s[r][0]},rn=la({pending:!1,data:null,method:null,action:null}),Gt=new Set,ln=t=>{Gt.add(t),t.finally(()=>Gt.delete(t))},kt=(t,a)=>sn(()=>i=>{let n;t&&(typeof t=="function"?n=t(i)||(()=>{t(null)}):t&&"current"in t&&(t.current=i,n=()=>{t.current=null}));const s=a(i);return()=>{s==null||s(),n==null||n()}},[t]),me=Object.create(null),ze=Object.create(null),qe=(t,a,i,n,s)=>{if(a!=null&&a.itemProp)return{tag:t,props:a,type:t,ref:a.ref};const r=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...m}=a,u=null,f=!1;const g=$e[t];let b;if(g.length>0){const E=r.querySelectorAll(t);e:for(const C of E)for(const x of $e[t])if(C.getAttribute(x)===a[x]){u=C;break e}if(!u){const C=g.reduce((x,L)=>a[L]===void 0?x:`${x}-${L}-${a[L]}`,t);f=!ze[C],u=ze[C]||(ze[C]=(()=>{const x=document.createElement(t);for(const L of g)a[L]!==void 0&&x.setAttribute(L,a[L]),a.rel&&x.setAttribute("rel",a.rel);return x})())}}else b=r.querySelectorAll(t);c=n?c??"":void 0,n&&(m[Ge]=c);const p=xt(E=>{if(g.length>0){let C=!1;for(const x of r.querySelectorAll(t)){if(C&&x.getAttribute(Ge)!==c){r.insertBefore(E,x);return}x.getAttribute(Ge)===c&&(C=!0)}r.appendChild(E)}else if(b){let C=!1;for(const x of b)if(x===E){C=!0;break}C||r.insertBefore(E,r.contains(b[0])?b[0]:r.querySelector(t)),b=void 0}},[c]),y=kt(a.ref,E=>{var L;const C=g[0];if(i===2&&(E.innerHTML=""),(f||b)&&p(E),!o&&!l)return;let x=me[L=E.getAttribute(C)]||(me[L]=new Promise((de,ae)=>{E.addEventListener("load",de),E.addEventListener("error",ae)}));l&&(x=x.then(l)),o&&(x=x.catch(o)),x.catch(()=>{})});if(s&&d==="render"){const E=$e[t][0];if(a[E]){const C=a[E],x=me[C]||(me[C]=new Promise((L,de)=>{p(u),u.addEventListener("load",L),u.addEventListener("error",de)}));nn(x)}}const w={tag:t,type:t,props:{...m,ref:y},ref:y};return w.p=i,u&&(w.e=u),en(w,r)},on=t=>{const a=Xi(),i=a&&Ee(a);return i!=null&&i.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:qe("title",t,void 0,!1,!1)},cn=t=>!t||["src","async"].some(a=>!t[a])?{tag:"script",props:t,type:"script",ref:t.ref}:qe("script",t,1,!1,!0),dn=t=>!t||!["href","precedence"].every(a=>a in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,qe("style",t,2,!0,!0)),hn=t=>!t||["onLoad","onError"].some(a=>a in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:qe("link",t,1,"precedence"in t,!0),mn=t=>qe("meta",t,void 0,!1,!1),Ba=Symbol(),un=t=>{const{action:a,...i}=t;typeof a!="function"&&(i.action=a);const[n,s]=an([null,!1]),r=xt(async d=>{const m=d.isTrusted?a:d.detail[Ba];if(typeof m!="function")return;d.preventDefault();const u=new FormData(d.target);s([u,!0]);const f=m(u);f instanceof Promise&&(ln(f),await f),s([null,!0])},[]),l=kt(t.ref,d=>(d.addEventListener("submit",r),()=>{d.removeEventListener("submit",r)})),[o,c]=n;return n[1]=!1,{tag:rn,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?a:null},children:{tag:"form",props:{...i,ref:l},type:"form",ref:l}},f:c}},Ha=(t,{formAction:a,...i})=>{if(typeof a=="function"){const n=xt(s=>{s.preventDefault(),s.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ba]:a}}))},[]);i.ref=kt(i.ref,s=>(s.addEventListener("click",n),()=>{s.removeEventListener("click",n)}))}return{tag:t,props:i,type:t,ref:i.ref}},fn=t=>Ha("input",t),pn=t=>Ha("button",t);Object.assign(ft,{title:on,script:cn,style:dn,link:hn,meta:mn,form:un,input:fn,button:pn});Nt(null);new TextEncoder;var gn=Nt(null),vn=(t,a,i,n)=>(s,r)=>{const l="<!DOCTYPE html>",o=i?Lt(d=>i(d,t),{Layout:a,...r},s):s,c=Ga`${j(l)}${Lt(gn.Provider,{value:t},o)}`;return t.html(c)},yn=(t,a)=>function(n,s){const r=n.getLayout()??ni;return t&&n.setLayout(l=>t({...l,Layout:r},n)),n.setRenderer(vn(n,r,t)),s()};const bn=yn(({children:t})=>e("html",{lang:"en",children:[e("head",{children:[e("meta",{charSet:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover"}),e("meta",{name:"format-detection",content:"telephone=no"}),e("meta",{name:"apple-mobile-web-app-capable",content:"yes"}),e("meta",{name:"apple-mobile-web-app-status-bar-style",content:"black-translucent"}),e("meta",{name:"mobile-web-app-capable",content:"yes"}),e("link",{rel:"dns-prefetch",href:"//fonts.googleapis.com"}),e("link",{rel:"dns-prefetch",href:"//fonts.gstatic.com"}),e("link",{rel:"dns-prefetch",href:"//cdnjs.cloudflare.com"}),e("link",{rel:"preconnect",href:"https://fonts.googleapis.com",crossOrigin:"anonymous"}),e("link",{rel:"preconnect",href:"https://fonts.gstatic.com",crossOrigin:"anonymous"}),e("link",{rel:"preload",href:"/static/style.css",as:"style"}),e("link",{rel:"preload",href:"https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap",as:"style"}),e("title",{children:"SCHOLARIX - Study Abroad Consultants | Visa, Admission & IELTS"}),e("meta",{name:"description",content:"Expert study abroad guidance for students. Get support for study visas, university admissions, scholarships, and IELTS/PTE preparation. 99% visa success rate. Book free consultation today!"}),e("meta",{name:"keywords",content:"study abroad, student visa, university admission, scholarships, IELTS, PTE, career counselling, international education"}),e("meta",{name:"author",content:"SCHOLARIX Study Abroad Consultants"}),e("meta",{property:"og:title",content:"SCHOLARIX - Study Abroad Consultants"}),e("meta",{property:"og:description",content:"Expert study abroad guidance with 99% visa success rate. Get support for visas, admissions, scholarships & test prep."}),e("meta",{property:"og:type",content:"website"}),e("meta",{property:"og:image",content:"/static/images/og-image.jpg"}),e("meta",{name:"twitter:card",content:"summary_large_image"}),e("meta",{name:"twitter:title",content:"SCHOLARIX - Study Abroad Consultants"}),e("meta",{name:"twitter:description",content:"Expert study abroad guidance with 99% visa success rate."}),e("meta",{httpEquiv:"Content-Security-Policy",content:"default-src 'self'; script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://unpkg.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data: https:; connect-src 'self' https:; frame-src 'none'; object-src 'none'; base-uri 'self';"}),e("meta",{httpEquiv:"X-Content-Type-Options",content:"nosniff"}),e("meta",{httpEquiv:"X-Frame-Options",content:"DENY"}),e("meta",{httpEquiv:"X-XSS-Protection",content:"1; mode=block"}),e("meta",{httpEquiv:"Referrer-Policy",content:"strict-origin-when-cross-origin"}),e("link",{rel:"icon",type:"image/png",href:"/static/images/scholarix-logo-icon-hd.png"}),e("link",{rel:"apple-touch-icon",href:"/static/images/scholarix-logo-icon-hd.png"}),e("style",{dangerouslySetInnerHTML:{__html:`
            :root {
...
Submitted: ${new Date(t.timestamp).toLocaleString()}
        `}},n=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(!n.ok)throw new Error(`Email service error: ${n.status}`);return console.log("Email notification sent successfully"),{success:!0}}catch(a){throw console.error("Email notification error:",a),a}}const Ut=new Pa,Sn=Object.assign({"/src/index.tsx":q});let Fa=!1;for(const[,t]of Object.entries(Sn))t&&(Ut.all("*",a=>{let i;try{i=a.executionCtx}catch{}return t.fetch(a.req.raw,a.env,i)}),Ut.notFound(a=>{let i;try{i=a.executionCtx}catch{}return t.fetch(a.req.raw,a.env,i)}),Fa=!0);if(!Fa)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{Ut as default};
